...
// instead of that, could u check by incrementing the distance,
// like distance +=10 or something like that? May be in phone
// its not able to find the framerate.. try this once.

// trex color snack p48(1);
//https://snack.expo.io/iwA7uO7-H
// https://snack.expo.io/@dhruvishah/t-rex-runner-color?
...
function draw(){
  ...
  text("Tap on the provided buttons",windowWidth/2-120,windowHeight/2+815)
  text("such as POT,ARROWS,RESTART",windowWidth/2-165,windowHeight/2+855)
  textSize(50)
  textFont("Helvetica")
  textStyle(BOLD)
  fill("orangered")
  // not windowHeight/29-450 but -780)
...
function spawnPlants(){
  if (frameCount%20===0) {
    cactus = createSprite(windowWidth/2, windowHeight/2-100);
    cactus.velocityY=40
...
function spawnFlowers(){
  if (frameCount%25===0) {
    flora=createSprite(windowWidth/2, windowHeight/2-100)
    flora.velocityY=30
...
function spawnGems(){
  if (frameCount%30===0) {
    gemy=createSprite(windowWidth/2, windowHeight/2-100)
    gemy.velocityY=20
...
function spawnChests() {
  if (frameCount%40===0) {
    chesty=createSprite(windowWidth/2, windowHeight/2-100)
    chesty.velocityY=35
